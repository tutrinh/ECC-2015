...
$.fn.storeLocator = function(options) {
  ...
  var userinput, olat, olng, marker, letter, storenum,map,autocomplete;
  var locationset = [];
  var featuredset = [];
  var normalset = [];
  var markers = [];
  ...
  //Clear value from search input box
  $('#'+settings.inputID).on("click focusin",function(){
      $(this).val('');
      //console.log($(this));
  });
  ...
  function begin_mapping(distance){
    ...
    //console.log('input value output: ' + userinput);//will ouput value from autocomplete box
        ...
        success: function (data, xhr, options){
            ...
            if(settings.dataType === 'json' || settings.dataType === 'jsonp'){
              ...
              $(data).find('marker').each(function(){
                var locationData = {
                  ...
                  'postal': $(this).find('zip').text(),
                  'country': $(this).find('country').text(),
                  'phone': $(this).find('phoneNumber').text(),
                  'email': $(this).find('email').text(),
                  'web': $(this).find('URL').text()
          ...
          $(function(){ 
             ...
             var key, value, locationData = {};
              ...
              map = new google.maps.Map(document.getElementById(settings.mapDiv),myOptions);
              $this.data('map', map);

                 //auto complete
                  var input = document.getElementById(settings.inputID);
              ...
              $(document).on('click.'+prefix, '#' + settings.listDiv + ' li', function(){
                ...
                $('.infoWrapper').parent().css('overflow',' visible');
